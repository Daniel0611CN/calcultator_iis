...
* **[`Statistics.java`](./src/main/java/org.iis.ajnebro/Statistics.java)**: A class providing statistical utility methods for arrays of numbers, utilizing `Apache Commons Math` for percentile calculations. It implements four methods: `maximumValue`, `minimumValue`, `mean`, and `median`.
